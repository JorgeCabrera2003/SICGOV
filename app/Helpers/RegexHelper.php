...
class RegexHelper
{
    ...
    public static function ValidarFormatos(string $valor, string $config)
    {
        ...
        $bool = match ($config) {
            ...
            "NombreObjetoLargo", "ObjetoLargo" => preg_match('/^[0-9 a-zA-ZáéíóúüñÑçÇ\s\-.,()!?¡¿]{3,200}$/u', $valor),
            "Descripcion" => preg_match('/^[0-9a-zA-ZÁÉÍÓÚÜáéíóúüñÑçÇ\s\-.,()!?"\'%:;\/¡¿]{0,200}$/u', $valor),
            "Titulo" => preg_match('/^[0-9a-zA-ZÁÉÍÓÚÜáéíóúüñÑçÇ\s\-.,()!?"\'%:;\/¡¿]{3,150}$/u', $valor),
