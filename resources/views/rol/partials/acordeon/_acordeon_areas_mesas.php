...
<div class="accordion-item">
    <h2 class="accordion-header" id="headingAreas-Mesas">
        <button class="accordion-button" type="button" data-bs-toggle="collapse"
            data-bs-target="#collapseAreas-Mesas" aria-expanded="false" aria-controls="collapseAreas-Mesas">
            Áreas y Mesas
        </button>
    </h2>
                    ...
                    <fieldset class="permission-group">
                        <legend class="group-header">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="group-area_mesa">Gestionar Áreas de las Mesas</label>
                            </div>
                        </legend>
