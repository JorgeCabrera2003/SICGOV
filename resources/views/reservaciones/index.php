<div class="container-fluid py-4 animate__animated animate__fadeIn">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <button class="btn btn-primary shadow-sm fw-bold px-4 rounded-pill" data-bs-toggle="modal" data-bs-target="#modalReservacion">
...
<div class="modal fade" id="modalReservacion" tabindex="-1" aria-labelledby="modalReservacionLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form id="formReservacion" method="POST" action="<?= BASE_URL ?>/?page=reservaciones">
