<!-- ==========================================
    MÓDULO DE CATEGORÍA INGREDIENTE - GOOD VIBES
...
<main class="container-fluid py-4">
    ...
    <section class="card shadow-sm border-0">
        <div class="card-body">
            <?php
            include_once 'partials/_tabla_categoria_ingrediente.php';
            ?>
        </div>
    </section>
</main>
...
<script type="module" src="<?= BASE_URL ?>/assets/js/Controllers/CategoriaIngredienteController.js" defer></script>