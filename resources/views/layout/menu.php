    ...
    <aside class="sidebar d-flex flex-column flex-shrink-0 vh-100 position-fixed" id="sidebar">
        ...
        <nav class="nav nav-pills flex-nowrap flex-column gap-1 px-2 py-3 flex-grow-1 overflow-auto"
            ...
            <div class="nav-item w-100 mb-1">
                ...
                <a class="nav-link d-flex align-items-center gap-2 <?php echo in_array($paginaPersonal, ['asistencia', 'cargo', 'empleado', 'turno', 'horario', 'tipopermiso', 'tipo_permiso', 'permisolaboral', 'permiso_laboral']) ? '' : 'collapsed'; ?>"
                ...
                <div class="collapse <?php echo in_array($paginaPersonal, ['asistencia', 'cargo', 'empleado', 'turno', 'horario', 'tipopermiso', 'tipo_permiso', 'permisolaboral', 'permiso_laboral']) ? 'show' : ''; ?>"
                    id="personal-submenu">
                    <div class="d-flex flex-column gap-1 ps-4 mt-1">
                        ...
                        <?php }
                        if (isset($permisosGlobales['permiso_laboral']['ver']) && $permisosGlobales['permiso_laboral']['ver'] == 1) {
                            ?>
