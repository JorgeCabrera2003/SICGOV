<!-- ==========================================
    MÓDULO DE PROVEEDORES - GOOD VIBES
...
<main class="container-fluid py-4">
    ...
    <header class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group" role="group" aria-label="Acciones de ingrediente">
            <button class="btn btn-warning text-dark fw-semibold" id="btnNuevoRol">
    ...
    <section class="card shadow-sm border-0">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="tablaRol" style="width:100%">
...
<?php
include_once 'partials/_modal_rol.php';
?>

<!-- Recursos específicos de la página -->
<script type="module" src="<?= BASE_URL ?>/assets/js/Controllers/RolController.js" defer></script>